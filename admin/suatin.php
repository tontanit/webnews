...
<body>
	...
	<div id="quantri">
		...
		<table>
			...
			<tr>
				<td nowrap="nowrap">TieuDe:</td>
				<td><input type="text" name="TieuDe" id="TieuDe" value="<?php echo $row_loaitin['Ten'] ?>"></td>
			</tr>
			<tr>
				<td nowrap="nowrap">TomTat</td>
				<td><input type="text" name="TomTat" id="TomTat" value="<?php echo $row_loaitin['ThuTu'] ?>" ></td>
			</tr>
			<tr>
				<td nowrap="nowrap">urlHinh</td>
				<td><input type="text" name="urlHinh" id="urlHinh" value="<?php echo $row_loaitin['ThuTu'] ?>" ></td>
			</tr>
