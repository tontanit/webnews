...
<div class="clear"></div>
	<ul>
      ...
      ?>
        ...
        <li>       
             <a href="#"><img src="upload/tintuc/<?php echo $row_tincungloai['urlHinh'] ?>" alt="Người nhà nạn nhân MH370 an ủi thân nhân hành khách MH17"></a> <br />
 			 <a class="title" href="#"><?php echo $row_tincungloai['TomTat'] ?></a>
             <span class="no_wrap">   
        </li>
